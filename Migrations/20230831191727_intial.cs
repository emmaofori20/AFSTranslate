...
namespace AFSTranslate.Migrations
{
    /// <inheritdoc />
    public partial class intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranslationTypes", x => x.TranslationTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Responses", x => x.ReponseId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responses_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responses_TranslationTypes_TranslationId",
                        column: x => x.TranslationId,
                        principalTable: "TranslationTypes",
                        principalColumn: "TranslationTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responses_StatusId",
                table: "Responses",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Responses_TranslationId",
                table: "Responses",
